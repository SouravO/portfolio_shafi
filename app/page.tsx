...
export default function GalleryCutHome() {
  ...
  return (
    <main ref={containerRef} className="relative bg-[#F9F9F9] overflow-x-hidden selection:bg-[#2C518A] selection:text-white">
      ...
      <section className="fixed top-0 left-0 w-full h-screen z-0 bg-white overflow-hidden">
        ...
        <div className="absolute right-16 top-20 w-72 h-72 pointer-events-none z-10">
      ...
      <div className="fixed top-0 left-0 w-full h-screen z-20 flex pointer-events-none">
        <motion.div style={{ x: leftPanelX }} className="relative h-full w-1/2 bg-white border-r border-zinc-100">
            <div className="absolute top-10 left-10 flex flex-col gap-1 opacity-40">
                <span className="text-[8px] font-black text-black uppercase">LAT: 12.9716° N</span>
                <span className="text-[8px] font-black text-black uppercase">LNG: 77.5946° E</span>
            </div>
        </motion.div>
          ...
          >
            <div className="flex flex-col md:flex-row items-end gap-10">
              ...
              <p className="text-xl md:text-2xl font-light text-zinc-400 max-w-md pb-4 italic">
                — Building systems that enable thousands of businesses to thrive.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-end gap-10">
              ...
              <p className="text-xl md:text-2xl font-light text-zinc-400 max-w-sm pb-4 italic text-right">
                — Where opportunities aren't created, they are engineered to multiply.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="relative z-30 bg-white py-40 border-y border-zinc-100">
        <div className="max-w-7xl mx-auto px-10">
          <div className="mb-20">
            <span className="text-[10px] font-black text-[#D4AF37] uppercase tracking-[1em]">The_Framework</span>
            <h3 className="text-6xl font-black uppercase mt-4">Global Scale Infrastructure</h3>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-xs font-mono text-[#2C518A]">0{i + 1} //</span>
                  </div>
                  <h4 className="text-3xl font-black uppercase mt-6 mb-4">{title}</h4>
                  <div className="w-0 group-hover:w-full h-[2px] bg-[#D4AF37] transition-all duration-500 mb-6" />
                  <p className="text-sm text-zinc-500 leading-relaxed">
                    Unified framework designed to accelerate growth and bridge jurisdictional gaps.
                  </p>
                </motion.div>
              );
            })}
      ...
      <section className="relative z-30 bg-zinc-50 py-40">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 border-b border-zinc-200 pb-10">
            <h2 className="text-8xl font-black uppercase tracking-tighter text-[#2C518A]">PROJECTS_</h2>
            <p className="text-xs font-black uppercase tracking-widest text-zinc-400 mb-4">Strategic_Deployments_v4.0</p>
          </div>

          
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              {['Startup Park', 'Incubenation', 'Global Initiatives'].map((project, idx) => (
                <motion.div 
                  key={project}
                ...
                >
                  ...
                  <span className="text-[10px] font-black text-zinc-300">MOD_{idx + 10}</span>
                  <div className="relative z-10">
                     <h4 className="text-4xl font-black uppercase tracking-tighter mb-4">{project}</h4>
